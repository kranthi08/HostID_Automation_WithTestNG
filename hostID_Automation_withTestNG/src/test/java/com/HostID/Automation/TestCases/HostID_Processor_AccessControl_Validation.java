...
public class HostID_Processor_AccessControl_Validation 
{
	...
	public void init() throws Throwable //String strBrowser,String strUrl,String initials,String networkPassword
	{
		...
		String initials = HostID_Utility.pf.getProperty("Processor_Initials");;
		String networkPassword = HostID_Utility.pf.getProperty("Processor_NetworkPassword");
	...
	public void create_Tab_Validations() throws Throwable
	{
		...
		String strtabOrder = reader.getCellData("Access_Control", "Accessor_TAB_Order", 4);
		String strVisibleLinks = reader.getCellData("Access_Control", "CreateTab_VisibleLinks", 4);
		String strInvisibleLinks = reader.getCellData("Access_Control", "CreateTab_InvisibleLinks", 4);
	...
	{
		String strInvisibleLinks = reader.getCellData("Access_Control", "ImportTab_InvisibleLinks", 4);
	...
	{
		String strInvisibleLinks = reader.getCellData("Access_Control", "JobsTab_InvisibleLinks", 4);
