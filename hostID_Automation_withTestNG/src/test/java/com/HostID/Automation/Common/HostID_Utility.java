...
public class HostID_Utility 
{
	...
	// Hover the mouse operation into a particular element
	// ==========================================================================================
		public void hoverTheMouseIntoElement(By oElement) throws Throwable
		{
			boolean hoverthemouseintoelement = false;
			int attempt=0;
			while(attempt < 3)
			{
				try
				{
					if(driver.findElement(oElement).isDisplayed())
					{
				        ...
				        action.moveToElement(element).build().perform();
				        hoverthemouseintoelement = true;
				        System.out.println("Perform the mouse hover operation on "+strText);
				        break;
					}
				}
				catch(Exception e)
				{
					...
					{
						System.out.println("Exception after refershing the driver");
					}
				}
				attempt++;
			}
	...
	public void verify_VisibilityOfLink(By objElement)
	{
		...
		try
		{	
			Assert.assertEquals(driver.findElement(objElement).isDisplayed(), true, driver.findElement(objElement).getAttribute("text")+" is displayed");
		...
		{
			System.out.println("verify_VisibilityOfLink - "+driver.findElement(objElement).getAttribute("text")+" is not displayed");
		}
	}
	// ==========================================================================================
	...
	public void verify_VisibilityOfLink(String strLinkText)
	{
		...
		try
		{
			Assert.assertEquals(driver.findElement(By.linkText(strLinkText)).isDisplayed(), true,"Link with Text - "+strLinkText+" is displayed");
		    verifyVisibilityOfLnk=true;
		}
		catch(Exception nse)
		{
		...
		if(verifyVisibilityOfLnk==false)
		{
			System.out.println("verify_VisibilityOfLink - "+strLinkText+" - Link Not displayed.");
		}
	}
	// ==========================================================================================
	...
	//======================================================================================================================
	public void selectItemFromWebList(By objElementName,String ItemValue) throws Throwable 
	{
